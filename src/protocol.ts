...
export function parseInput(line: string): InputMessage {
  ...
  if (!isRecord(value) || (value.version !== protocolVersion && value.version !== protocolVersionV3 && value.version !== protocolVersionV4 && value.version !== protocolVersionV5 && value.version !== protocolVersionV6 && value.version !== protocolVersionV7 && value.version !== protocolVersionV8 && value.version !== protocolVersionV9) || typeof value.type !== "string" || typeof value.requestId !== "string") {
